        ...
        when (holder.itemViewType) {
            MultipleEntity.TWO -> {
                ...
                if (item.status) {
                    ...
                    holder.getView<TextView>(R.id.tv_status).text = context.resources.getString(R.string.connected_status)
                    ...
                    holder.getView<TextView>(R.id.tv_status).text = context.resources.getString(R.string.disconnected_status)
